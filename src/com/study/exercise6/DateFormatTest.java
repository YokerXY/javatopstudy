...
public class DateFormatTest{
    public static void main(String[] args) {
        ...
        DateFormat df6 = new SimpleDateFormat("yyyy-年MM月dd日");
        //将日期按照不同的格式进行输出
        System.out.println("-------将日期时间按照不同格式形式输出-----");
        ...
        System.out.println("按=按照指定格式 yyyy-MM-dd: "+df5.format(date));
        System.out.println("按照指定格式 yyyy-MM-dd日: "+df6.format(date));
